...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>MY BEAUTY</strong> </a>
    ...
    <div class="container">
      ...
      <form method="POST" action="">
        <div class="form-group">
          <label for="menu1">Nama Pembeli</label>
          <input type="text" class="form-control" id="menu1" name="nama_pembeli">
        </div>
        <div class="form-group">
          <label for="menu1">NO HP</label>
          <input type="text" class="form-control" id="menu1" name="nohp">
        </div>
      ...
      if(isset($_POST['konfirm'])) {
        ...
        $nohp = $_POST['nohp'];
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO pemesanan (tanggal_pemesanan, total_belanja, nama_pembeli, nohp) VALUES ('$tanggal_pemesanan', '$totalbelanja','$nama_pembeli','$nohp')");
